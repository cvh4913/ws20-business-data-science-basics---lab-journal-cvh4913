...
![Firure: Sales for different Cities](02_figures/Tech_sectors.png)
...
![Firure: Sales for different Cities](02_figures/covid_figure.png)
...
![Firure: Sales for different Cities](02_figures/COVID_Map.png)
Tho color map used is a pre defined one illustrating the countries with the highest mortality rates in bright yellow and the countries with the lowest mortality rates in deep blue.
